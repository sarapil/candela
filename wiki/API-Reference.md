...
All Candela APIs follow the Arkan Lab API standards.

## Base URL — الرابط الأساسي

```
POST /api/method/candela.api.v1.<module>.<function>
```
...
```bash
curl -X POST 'https://site.example.com/api/method/candela.api.v1.records.get_list' \
