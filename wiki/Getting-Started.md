...
bench get-app candela https://github.com/sarapil/candela.git

# Install on site — التثبيت على الموقع
bench --site your-site.localhost install-app candela
...
2. **Find the App** — ابحث عن التطبيق: Look for Candela icon on the desk
3. **Configure Settings** — اضبط الإعدادات: Go to Candela Settings
...
- 🐛 [Report Bug](https://github.com/sarapil/candela/issues/new?template=bug_report.yml)
- ✨ [Request Feature](https://github.com/sarapil/candela/issues/new?template=feature_request.yml)
