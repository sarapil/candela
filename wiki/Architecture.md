...
Candela follows the Arkan Lab architecture standards built on Frappe v16.
...
class MyDocType(Document):
    def validate(self):
        from candela.services.my_service import MyService
...
```python
from candela.api.response import success, error, paginated
