...
```bash
bench --site dev.localhost get-untranslated ar --app candela
```

### 2. Translation file format — تنسيق ملف الترجمة

File: `candela/translations/ar.csv`
...
bench --site dev.localhost get-untranslated ar --app candela | wc -l
```
...
2. Edit/create the CSV file in `candela/translations/`
