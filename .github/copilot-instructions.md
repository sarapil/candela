# Candela Restaurant — AI Copilot Instructions

## Overview

**Candela Restaurant** (candela) is an Arkan Lab Frappe v16 application.
Italian Café & Restaurant Website + Operations Backend
