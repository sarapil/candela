...
# ─── Includes ────────────────────────────────────────────────────────
# Desk (admin) assets
# CODESPACES: app_include_css = ["/assets/candela/css/candela_combined.css"]
# CODESPACES: app_include_js = ["/assets/candela/js/candela_combined.js"]
...
after_migrate = ["candela.seed.seed_data"]
