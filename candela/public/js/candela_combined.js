/* candela — Combined JS (reduces HTTP requests) */
/* Auto-generated from 3 individual files */


/* === candela_workspace.js === */
...
// License: MIT
// frappe_visual Integration for Candela Restaurant
...
(function() {
    ...
    if (frappe.get_route_str() === 'candela-settings') {
    ...
    // Visual Reports Hub
    if (frappe.get_route_str() === 'candela-reports') {
        const page = frappe.container.page;
        if (page && page.main && frappe.visual.generator) {
