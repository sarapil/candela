...
### What is Candela?
Candela is a project & task management solution built on the Frappe Framework, designed with Arabic-first support and CAPS-based access control.
...
Candela uses CAPS (Capability-Based Access Control). Assign capabilities through the CAPS user management screen.
...
### ما هو Candela؟
Candela هو حل Project & Task Management مبني على إطار عمل فريب مع دعم كامل للعربية.
